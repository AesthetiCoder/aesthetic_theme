import {
  gray, cyan, amber, emerald, information
...
const common = [
  ...
  },
  {
    ...
    scope: [
      'string.regexp', 'source.regexp', 'constant.character.escape'
    ],
    settings: {
  ...
  },
  {
    ...
    scope: [
      'storage', 'storage.type', 'keyword', 'keyword.operator'
    ],
    settings: {
      fontStyle: 'bold',
      foreground: information.information_600
  ...
  },
  {
    ...
    scope: [
      'support.type', 'support.class', 'support.function'
    ],
    settings: {
      foreground: cyan.cyan_600
    }
