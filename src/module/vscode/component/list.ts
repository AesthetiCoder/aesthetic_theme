import {
  gray, base, danger, background
} from '../../../global/theme/color';

const list = {
  'list.activeSelectionBackground': gray.gray_800,
  ...
  'list.inactiveSelectionForeground': gray.gray_400,

  'listFilterWidget.noMatchesOutline': danger.danger_600,
